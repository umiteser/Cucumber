...
public class _10_Soru {
    ...
    public static ArrayList< ArrayList<String> > getData(String path, String sheetName, int sutunSayisi) {
        ...
        {
            System.out.println(ex.getMessage());   //try catch yapmazsan kod uzuyor. throw exception eklemek zorunda kalıyorsun.
        }
        ...
        return tablo;  //void olmadığı için fonksiyon return yapmalısın.
    }
}
