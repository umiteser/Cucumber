...
public class _06_GetAllRowColumn extends JDBCParent {
    ...
    public void Test1() throws SQLException {
        ...
        rs.next(); // ilk satıra geldik
        System.out.println("id = " + rs.getString(1));
        System.out.println("id = " + rs.getString("city_id"));
        //sadece getString ile almak zorunda değilsin, getInt te kullanabilirsin
        int intID=rs.getInt("city_id"); //kolonun tipine uygun ise4 get ile de alabilirsin
    ...
    public void Test2() throws SQLException {
        ...
        int kolonSayisi= rsmd.getColumnCount();  //kolon sayısını öğreniyoruz.
